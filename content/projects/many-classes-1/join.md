...
## <a name="apply"></a> 
<button style="display: inline-block; text-align: center; text-decoration: none; margin: 2px 0; border: solid 1px transparent; border-radius: 4px; padding: 0.5em 1em; color: #ffffff; background-color: #9555af;" type="button"><span>Apply for your course to join ManyClasses.</span></button>
